			...
			<div id="wrapper">
				<div id="leftcolumn_whereami">
		  		...
		  		<div id="contentcolumn">
		  			<h2><strong>Punk</strong></h2>

					<form method="get" action="sort.php" enctype="text/plain" id="sort_form">	
            		...
            		<?php
            		$result = mysqli_query($connect, "SELECT * FROM Catalogue WHERE Genre='Punk'");
            		while($product = mysqli_fetch_object($result)){
