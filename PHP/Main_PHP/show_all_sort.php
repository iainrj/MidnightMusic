			...
			<div id="wrapper">
				<div id="leftcolumn_whereami">
		  		...
		  		<div id="contentcolumn">
					...
					<?php
						// Search the catalogue against the user input and output the result / Only fully correct terms will work but case insensitive
						    $sort_by = $_GET['Sort_by'];
						    $sort_asc_desc = $_GET['order'];

						    $query = mysqli_query($connect, "SELECT * FROM Catalogue ORDER BY $sort_by $sort_asc_desc");
